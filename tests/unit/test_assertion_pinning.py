...
from architecture_validator.adapters.gcp.iap_identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("architecture_validator.adapters.gcp.iap_identity")
