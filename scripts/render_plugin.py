...
def build_spec() -> PluginSpec:
    ...
    from architecture_validator.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from architecture_validator.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/architecture-validator",
        ...
        servers={
            "architecture-validator": StdioServer(
                command="python",
                args=("-m", "architecture_validator.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
