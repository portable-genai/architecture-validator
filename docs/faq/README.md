...
| [features-faq.md](features-faq.md) | Product / architecture-review-board / delivery | what the gate does, what is deterministic vs LLM, the OPA/Rego policy-as-code angle, and the boundary with sibling platform systems |
| [adoption-faq.md](adoption-faq.md) | Engineering leads forking the repo | rename, upstream fixes, extension points, versioning |
| [compliance-faq.md](compliance-faq.md) | Compliance / risk / model risk | regulatory posture, PII, maker-checker, residency, model-risk evidence |
...
another repo (the reg-KB, the eval platform, the human-review console, ...), the FAQ points
