...
R6 refers to ("any new project SHOULD pass Rsk3 at intake"). It validates a project's design,
...
to the Hrz7 Human-Review and Maker-Checker Console (rule R8) for a qualified human to dispose.
...
It is not present. Rsk3 processes **project metadata and design documents, not customer PII**
...
the runtime DLP/guardrail for a project that *does* handle PII is the sibling **Hrz1**
gateway, which such a project consumes.
...
submission. The enterprise WORM audit system is **Hrz5**; the in-repo store is the offline
...
promotion gate and model documentation / red-team harness are the sibling **Hrz4** system
...
naming who owns the MAS / HKMA / APRA / FSA mapping; at scale the sibling **Rsk1 compliance
...
in-process; the exit / concentration-risk plan belongs to the sibling **Rgc9
...
rebuild the eval golden set, wire your IdP and Hrz7 endpoint, that precede production use.
