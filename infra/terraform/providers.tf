# providers.tf — Provider pinning for the C3 Architecture Validator sovereign deploy.
#
...
#
# google-beta is required because several sovereignty resources (Assured Workloads, some
