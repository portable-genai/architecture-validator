...
satisfied the schema to :class:`ModelOutputError`; the drafting callers degrade to their
deterministic fallback on either, as they do when the managed model fails.
"""
