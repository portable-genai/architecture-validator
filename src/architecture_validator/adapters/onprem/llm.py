"""On-prem placeholder for ``LLMPort`` — the on-premise migration target.
...
interface parity. Porting C3 on-premise (e.g. to a self-hosted Gemma model server) is
...
class OnPremLLMAdapter:
    """Placeholder LLM adapter for the on-prem migration profile."""
