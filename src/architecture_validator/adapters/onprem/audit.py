...
discarding the event: an unimplemented audit sink must never silently drop a governance
...
class OnPremAuditAdapter:
    """Placeholder audit-sink adapter for the on-prem migration profile."""
