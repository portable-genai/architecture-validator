"""On-prem placeholder for ``ObservabilityTracerPort`` — on-premise migration target.

One of the reversibility (P-02, P-12) migration placeholders. Unlike the policy/audit
...
wired up yet, instead of crashing on a missing tracer. The adapter constructs cleanly
...
class OnPremTracerAdapter:
    """Placeholder tracer adapter for the on-prem migration profile.
