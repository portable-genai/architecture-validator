...
release through unevaluated, so porting on-premise *must* supply a real eval backend.
...
class OnPremEvalAdapter:
    """Placeholder evaluation-gate adapter for the on-prem migration profile."""
